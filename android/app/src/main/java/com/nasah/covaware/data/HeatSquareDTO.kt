...
private const val MAX_HEAT_VALUE = 100
...
fun Double.toRisk(): Risk{
	return when{
		this > 80 -> Risk.EXTREMELY_HIGH
		this > 60 -> Risk.HIGH
		this > 40 -> Risk.MODERATE
		this > 20 -> Risk.LOW
		else -> Risk.MINIMAL
	}
}
...
data class HeatSquareDTO(
	@SerializedName("risk") val risk: Double? = null,
	...
	fun toHeatMapSquare(): HeatMapSquare {
		return HeatMapSquare(
			...
			color = COLORS[BORDERS.indexOfFirst { (risk ?: 0.0) >= it }]
		)
	}
}
